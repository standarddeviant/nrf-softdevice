...
def main [] {
  ...
  let name = ($select_list | input list --fuzzy)
  ...
  cargo build --bin $name --features nrf52805 --release
  ...
  mergehex -m s112_nrf52_7.3.0_softdevice.hex $hpath -o sd112_app.hex

  # echo $'($INFO) converting merged .hex to merged .uf2 file ...(ansi reset)'
  # python uf2conv.py -f 0xADA52840 -c -b 0x1000 -o sd112_app.uf2 sd112_app.hex
}
